...
example = {
    "instruction": "You are a doctor. Write a detailed discharge summary including the patient's hospitalization course, interventions, and follow-up plan.",
    "input": (
        "Patient: 55-year-old female with a history of type 2 diabetes mellitus and hypertension. "
        "She was admitted with acute kidney injury secondary to sepsis from a urinary tract infection. "
        "During her hospital stay, she received aggressive IV fluid resuscitation, broad-spectrum antibiotics, and careful electrolyte management. "
        "Her renal function gradually improved over a 4-day admission, and she was transitioned to oral medications prior to discharge. "
        "A follow-up appointment with nephrology has been scheduled for further evaluation and monitoring of her kidney function."
    )
}
